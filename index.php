...
<head>
    <meta charset="utf-8">
    <title>Portfolio Of Rajan Joriya</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
        <a href="index.html" class="navbar-brand ml-lg-3">
            <h1 class="m-0 display-5"><span class="text-primary">Rajan </span>Joriya</h1>
        </a>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 text-center text-lg-left">
                    ...
                    <h1 class="display-3 text-uppercase text-primary mb-2" style="-webkit-text-stroke: 2px #ffffff;">Rajan Joriya</h1>
                    <h1 class="typed-text-output d-inline font-weight-lighter text-white"></h1>
                    <div class="typed-text d-none">Web Designer, Web Developer, Front End Developer, Back End Developer, Video Editor, Content Creator, Graphic Designer</div>
    ...
    <div class="container-fluid py-5" id="about">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <h3 class="mb-4">Web Developer, Graphic Designer, Video Editor, Content Writer & Content Creator</h3>
                    <p>Multi-talented professional skilled in web development, graphic design, video editing, content writing, and content creation. With a passion for creativity and innovation, I bring diverse expertise to craft engaging digital experiences, captivating visuals, and compelling written content. Let's collaborate to make an impact across multiple domains.</p>
                    <div class="row mb-3">
                        <div class="col-sm-6 py-2"><h6>Name: <span class="text-secondary">Rajan Joriya</span></h6></div>
                        <div class="col-sm-6 py-2"><h6>Birthday: <span class="text-secondary">28 March 2002</span></h6></div>
                        ...
                        <div class="col-sm-6 py-2"><h6>Phone: <span class="text-secondary">+91 8112895711</span></h6></div>
                        <div class="col-sm-6 py-2"><h6>Email: <span class="text-secondary">Rajanjoriya000000@gmail.com</span></h6></div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="border-left border-primary pt-2 pl-4 ml-2">
                        <div class="position-relative mb-4">
                            ...
                            <p class="mb-2"><strong>Raj Montessori Inter College Semri Sultanpur, UP</strong> | <small>2008 - 2020</small></p>
                            <p>A dedicated learner with a passion for academics, excelling in various subjects and extracurriculars. Embracing challenges, leadership roles, and community involvement to foster growth and learning.</p>
                        </div>
                        <div class="position-relative mb-4">
                            <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                            <h5 class="font-weight-bold mb-1">Bachelor</h5>
                            <p class="mb-2"><strong>Doaba College, Jalandhar</strong> | <small>2020 - 2023</small></p>
                            <p>Bachelor's degree holder with a strong academic record and specialized knowledge in Digital Field. Committed to continuous learning and eager to apply expertise in real-world projects.</p>
                        </div>
                        <div class="position-relative mb-4">
                            <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                            <h5 class="font-weight-bold mb-1">Internship</h5>
                            <p class="mb-2"><strong>Internshala</strong> | <small>2023 - 2024</small></p>
                            <p>Completed 3 months internship in Internshala. Gained practical experience, collaborated on projects, and developed essential skills. Thrived in a dynamic work environment, ready to tackle new challenges.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="border-left border-primary pt-2 pl-4 ml-2">
                        <div class="position-relative mb-4">
                            <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                            <h5 class="font-weight-bold mb-1">Web Designing</h5>
                            <p class="mb-2"><strong>Kuroit Company</strong> | <small>2023 - 2024</small></p>
                            <p>Passionate web designer with HTML, CSS, JavaScript expertise. Ready to create captivating interfaces, eager to collaborate and innovate. Let's design together!</p>
                        </div>
                        <div class="position-relative mb-4">
                            <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                            ...
                            <p class="mb-2"><strong>Kuroit Company</strong> | <small>2023 - 2024</small></p>
                            <p>
                                Experienced web developer with expertise in HTML, CSS, JavaScript & Backend Technology. Collaborative and innovative mindset, eager to create exceptional online experiences. Let's code together!</p>
                        </div>
                        <div class="position-relative mb-4">
                            <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                            <h5 class="font-weight-bold mb-1">Video Editing</h5>
                            <p class="mb-2"><strong>Freelance</strong> | <small>2020 - 2024</small></p>
                            <p>Creative video editor skilled in crafting captivating visual narratives. Experienced in editing, adding effects, and enhancing footage. Let's bring stories to life!</p>
                        </div>
                        <div class="position-relative mb-4">
                            <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                            <h5 class="font-weight-bold mb-1">Content Writing & Creating</h5>
                            <p class="mb-2"><strong>Freelance</strong> | <small>2020 - 2024</small></p>
                            <p>Versatile content writer and creator crafting engaging articles and multimedia content. Adept at storytelling and delivering valuable insights. Let's create compelling content together!</p>
                        </div>
                        <div class="position-relative mb-4">
                            <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                            <h5 class="font-weight-bold mb-1">Graphic Designing</h5>
                            <p class="mb-2"><strong>Freelance</strong> | <small>2020 - 2024</small></p>
                            <p>
                                Talented graphic designer creating eye-catching visuals and marketing materials. Proficient in conveying messages through creative design. Let's bring ideas to life!</p>
                        </div>
                        <div class="position-relative mb-4">
                            <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                            <h5 class="font-weight-bold mb-1">SEO</h5>
                            <p class="mb-2"><strong>Freelance</strong> | <small>2020 - 2024</small></p>
                            <p>
                                SEO expert optimizing websites for higher search engine rankings. Driving organic traffic and enhancing online presence. Let's boost your visibility!</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <div class="skill mb-4">
                        <div class="d-flex justify-content-between">
                            <h6 class="font-weight-bold">Ajax</h6>
                            <h6 class="font-weight-bold">90%</h6>
                        </div>
                        <div class="progress">
                ...
                <div class="col-md-6">
                    ...
                    <div class="skill mb-4">
                        <div class="d-flex justify-content-between">
                            <h6 class="font-weight-bold">JSON</h6>
                            <h6 class="font-weight-bold">95%</h6>
                        </div>
                        <div class="progress">
                    ...
                    <div class="skill mb-4">
                        ...
                        <div class="progress">
                            <div class="progress-bar bg-" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="col-lg-4 col-md-6 text-center mb-5">
                    ...
                    <p>
                        Passionate web designer crafting captivating digital experiences through user-centric design. Expertise in responsive layouts, intuitive navigation, and visually engaging interfaces using HTML, CSS, and JavaScript. Let's bring your vision to life!</p>
                ...
                <div class="col-lg-4 col-md-6 text-center mb-5">
                    ...
                    <p>Web development empowers the creation and maintenance of websites. It encompasses front-end development (HTML, CSS, JavaScript) for user interfaces, back-end development for server-side operations, and database management. Collaborate with me to build your online success.</p>
                    <a class="border-bottom border-primary text-decoration-none" href="">Read More</a>
                </div>
                <div class="col-lg-4 col-md-6 text-center mb-5">
                    <div class="d-flex align-items-center justify-content-center mb-4">
                    ...
                    <p>Video editing is the art of arranging and manipulating video clips to create a cohesive and impactful visual story. With precision and creativity, I enhance footage, add effects, and perfect audio, resulting in compelling videos that captivate audiences.</p>
                    <a class="border-bottom border-primary text-decoration-none" href="">Read More</a>
                </div>
                <div class="col-lg-4 col-md-6 text-center mb-5">
                    <div class="d-flex align-items-center justify-content-center mb-4">
                        <i class="fab fa-2x fa-apple service-icon bg-primary text-white mr-3"></i>
                        <h4 class="font-weight-bold m-0">Graphic Desiging</h4>
                    </div>
                    <p>Graphic designing is the art of conveying messages through visual elements. Using my creativity and technical skills, I craft eye-catching logos, illustrations, and marketing materials that communicate ideas effectively, leaving a lasting impression on audiences.</p>
                    <a class="border-bottom border-primary text-decoration-none" href="">Read More</a>
                </div>
                <div class="col-lg-4 col-md-6 text-center mb-5">
                    <div class="d-flex align-items-center justify-content-center mb-4">
                    ...
                    <p>SEO (Search Engine Optimization) is the process of enhancing a website's visibility in search engine results. By optimizing content, keywords, and metadata, I drive organic traffic, improve rankings, and ensure your online presence reaches its full potential.</p>
                    <a class="border-bottom border-primary text-decoration-none" href="">Read More</a>
                </div>
                <div class="col-lg-4 col-md-6 text-center mb-5">
                    <div class="d-flex align-items-center justify-content-center mb-4">
                        <i class="fa fa-2x fa-edit service-icon bg-primary text-white mr-3"></i>
                        <h4 class="font-weight-bold m-0">Content Writing & Creating</h4>
                    </div>
                    <p>Content writing and creating is the art of crafting compelling and valuable content for various mediums. With expertise in storytelling and audience engagement, I deliver informative articles, captivating blog posts, and multimedia content that resonates with your target audience.
                    </p>
                    <a class="border-bottom border-primary text-decoration-none" href="">Read More</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            ?>
                <div class="col-lg-4 mb-5">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded w-100" src="blogpost/img/<?php echo $row["img"]   ?>" alt="Image">
                        <div class="blog-date">
                        ...
                        <small class="text-white text-uppercase">
                            <?php
                        // Given date
                        $dateString = "2023-07-21 13:43:18";
                    ...
                    <h5 class="font-weight-medium mb-4"><?php echo $row["title"] ;?></h5>
                    <a class="btn btn-sm btn-outline-primary py-2" href="singleblog.php?id=<?php echo $row["id"] ?>">Read More</a>
                </div>
                <?php
                        
                    }
                } else {
                  echo "<p style='color: red;'>There is no blog available right now.</p>";
                }
                ?>
            </div>
        </div>
